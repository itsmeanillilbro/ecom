<div>
    <footer class="bg-gray-900 w-full">
        ...
        <a class="flex-none text-xl font-semibold text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Brand">DCodeMania</a>
                ...
                <!-- End Col -->
                <div class="col-span-2 lg:w-80 text-center md:text-left w-full">
            ...
            <div class="mt-5 sm:mt-12"> <!-- Social Brands -->
                <div class="flex  justify-center">
                    <a class="w-10 h-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-white hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600"
                        href="https://www.facebook.com/profile.php?id=100009719057574">
