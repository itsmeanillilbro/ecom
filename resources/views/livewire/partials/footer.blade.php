<div>
    <footer class="bg-gray-900 w-full">
        <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
            <!-- Grid -->
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 justify-items-center ">
        ...
        <a class="flex-none text-xl font-semibold text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Brand">DCodeMania</a>
                ...
                <!-- End Col -->
                <div class="col-span-full lg:col-span-2 text-center">
            ...
            <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 md:flex sm:justify-between ">
                <div class="flex justify-between items-center sm:col-span-full sm:text-center ">
                    <p class="text-sm text-gray-400">©<?php echo date('Y') ?> Erasoft Solution. All rights reserved.</p>
                </div>
                <!-- End Col -->
