            ...
            <div class="relative md:flex md:items-center md:justify-between">
                <div class="flex items-center justify-between">
                    <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        href="/" aria-label="Brand">Daraz Lite</a>
                    <div class="md:hidden">
                        <button type="button"
                ...
                <div id="navbar-collapse-with-animation"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <a wire:navigate
                                class="font-medium  {{request()->is('products') ? 'text-blue-600' : 'text-gray-600'}} hover:text-gray-400 py-3 md:py-6 dark: {{request()->is('products') ? 'text-blue-600' : 'text-gray-600'}}  dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                href="/products">
                                Products
                            </a>

                            <a wire:navigate
                                class="font-medium  {{request()->is('cart') ? 'text-blue-600' : 'text-gray-600'}} flex items-center hover:text-gray-400 py-3 md:py-6 dark: {{request()->is('cart') ? 'text-blue-600' : 'text-gray-600'}}  dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                href="/cart">
