        ...
        <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{asset('storage/'. $product->images[0])}}' }">
          <div class="sticky top-0 z-50 overflow-hidden ">
            ...
            <div class="flex-wrap hidden md:flex ">
              <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{asset('storage/'. $product->images[0])}}'">
                <img src={{asset('storage/'. $product->images[0])}} alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
              </div>

              <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{asset('storage/'. $product->images[1])}}'">
                <img src="{{asset('storage/'. $product->images[1])}}" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
              </div>

              <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{asset('storage/'. $product->images[2])}}'">
                <img src="{{asset('storage/'. $product->images[2])}}" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
              </div>
