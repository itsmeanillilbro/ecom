                ...
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full mb-8 md:w-1/2 md:mb-0"
                        ...
                        <div class="sticky top-0 z-50 overflow-hidden ">
                            <div class="relative mb-6 lg:mb-10 flex justify-center items-center" style="height: 400px; width: 100%;">
                                <img x-bind:src="mainImage" alt="" class="object-cover w-full h-full">
                            </div>
